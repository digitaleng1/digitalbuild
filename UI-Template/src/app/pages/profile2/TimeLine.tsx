...
import type { Comment, Person } from '@/app/apps/social/types';
...
const PostComment = ({ comment }: PostCommentProps) => {
	return (
		<div className="d-flex">
			{comment.author.avatar && <img className="me-2 rounded-circle" src={comment.author.avatar} alt="" height="32" />}
			<div>
				<h5 className="mt-0">
...
const Post = ({ post, user }: PostProps) => {
	return (
		<div className="border border-light rounded p-2 mb-3">
			<div className="d-flex">
				{post.author.avatar && <img className="me-2 rounded-circle" src={post.author.avatar} alt="" height="32" />}
				<div>
					...
					{user && (
						<div className="d-flex mt-2">
							<Link to="" className="pe-2">
								{user.avatar && <img src={user.avatar} height="32" className="rounded-circle" alt="" />}
							</Link>
							<div className="w-100">
