			...
			return (
				<Link to="" className="dropdown-item notify-item p-0">
					<div className="d-flex">
						{option.userDetails?.avatar && <img src={option.userDetails.avatar} alt="" className="d-flex me-2 rounded-circle" height="32" />}
						<div className="w-100">
...
const Control = (props: any) => {
	...
	return (
		<components.Control {...props}>
			<span onMouseDown={handleClick} className="ri-search-line search-icon"></span>
			{props.children}
		</components.Control>
	);
};
