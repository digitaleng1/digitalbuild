...
public class InvalidProjectStatusException : ArgumentException
{
    ...
    public InvalidProjectStatusException(string status) 
        : base($"Invalid project status: '{status}'. Allowed values: QuotePending, Draft, QuoteSubmitted, QuoteAccepted, InitialPaymentPending, InitialPaymentComplete, InProgress, Completed, Cancelled")
    {
