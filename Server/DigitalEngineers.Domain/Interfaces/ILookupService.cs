...
public interface ILookupService
{
    ...
    // Admin operations
    Task<ProfessionDto> CreateProfessionAsync(CreateProfessionDto dto, CancellationToken cancellationToken = default);
    Task<LicenseTypeDto> CreateLicenseTypeAsync(CreateLicenseTypeDto dto, CancellationToken cancellationToken = default);
