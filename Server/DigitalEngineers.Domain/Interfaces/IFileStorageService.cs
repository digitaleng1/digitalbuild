...
public interface IFileStorageService
{
    ...
    Task<string> UploadBidResponseFileAsync(Stream fileStream, string fileName, string contentType, int bidResponseId, CancellationToken cancellationToken = default);
