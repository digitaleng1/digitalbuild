import { ThemeSettings, useThemeContext, clearStoredSettings } from '@/common/context';

export default function useThemeCustomizer() {
	const { settings, updateSettings, updateLayout, updateTopbar, updateSidebar, toggleTemplateMenu } = useThemeContext();
	...
	/**
	 * Toggles the menu type (template vs role-based)
	 */
