...
import type { Feature, LayoutDemo, Service } from './types';
...
const rawFaqs: FAQItem[] = [
	...
	},
	{
		...
		answer: 'Use our dedicated support email (support@digital-engineers.com) to send your issues or feedback. We are here to help anytime.',
		titleClass: 'text-body',
		textClass: 'pb-1 text-muted',
	},
	{
