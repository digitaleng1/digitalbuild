			...
			<CardBody>
				...
				<Row>
					<Col>
						...
						<Row className="mt-3">
							<Col>
								<ReactQuill  theme="bubble" value={editorState} onChange={onEditorStateChange} style={{ height: 135 }} />
							</Col>
						</Row>
										...
										<Row className="align-items-center">
											...
											<Col className="col-auto">
												<OverlayTrigger placement="left" overlay={<Tooltip>Download</Tooltip>}>
													<Link to="" id="btn-download" className="btn btn-link text-muted btn-lg p-0 me-1">
														<i className="uil uil-cloud-download"></i>
													</Link>
												</OverlayTrigger>
												<OverlayTrigger placement="left" overlay={<Tooltip>Delete</Tooltip>}>
													<Link to="" id="btn-Delete" className="btn btn-link text-danger btn-lg p-0">
