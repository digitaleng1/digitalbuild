...
import { StatisticsChartWidget, StatisticsChartWidget2, StatisticsChartWidget3, StatisticsWidget } from '@/components/StatsWidgets';
		...
		<Card className={classnames('widget-flat')}>
			<CardBody>
				<span className="float-start m-2 me-4">
					<img src={profileImg} height={100} width={100} style={{ height: '100px' }} alt="" className="rounded-circle img-thumbnail" />
				</span>
	...
	return (
		<Card>
			<CardBody className="p-0">
				...
				<SimplebarReactClient className="px-3" style={{ maxHeight: '337px', width: '100%' }}>
					<Timeline>
						<TimelineItem>
	...
	return (
		<Card>
			<CardBody className="p-0">
				...
				<SimplebarReactClient className="px-3" style={{ maxHeight: '335px', overflowX: 'hidden' }}>
...
const WidgetsUI = () => {
	...
	return (
		<>
			...
			<Row>
				<Col xl={4}>
					<ChatList chatMessages={chatMessages} showHeader></ChatList>
				</Col>
