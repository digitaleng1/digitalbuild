...
const ListPage = () => {
    ...
    const handleAddNew = useCallback(() => {
        if (!canEdit) {
            showError('Action Not Allowed', 'You cannot create tasks in Novobid managed projects');
            return;
        }
    ...
    const handleTaskMove = useCallback(async (taskId: number, newStatusId: number) => {
        if (!canEdit) {
            showError('Action Not Allowed', 'You cannot move tasks in Novobid managed projects');
            return;
        }
